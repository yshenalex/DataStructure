...
void test1_2()
{
	...
	// 查找测试
	cout << "Find 30: " << (ht.find(30) == true ? "Found" : "Not Found") << endl;
	cout << "Find 45: " << (ht.find(45) == true ? "Found" : "Not Found") << endl;
	...
	// 再次查找已删除元素
	cout << "Find 30 after erase: " << (ht.find(30) == true ? "Found" : "Not Found") << endl;
}
...
void test4_2()
{
	...
	cout << "Find 'banana': " << (ht.find("banana") ==true ? "Found" : "Not Found") << endl;
	cout << "Find 'kiwi': " << (ht.find("kiwi") == true ? "Found" : "Not Found") << endl;
